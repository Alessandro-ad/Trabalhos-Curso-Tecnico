...
function Ogro(context, personagem, fundo, larguraIni, alturaIni, posInicX, posInicY, linhas, colunas, leitura, dificult) { 
...
Ogro.prototype = { 
   ...
   retangulosColisao: function() {
      var rets = [
         {
           x: this.x, y: this.y, largura: 90, altura:  90
         }
      ];

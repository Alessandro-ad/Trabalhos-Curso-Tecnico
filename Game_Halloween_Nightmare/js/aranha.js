...
function Aranha(context, personagem, fundo, larguraIni, alturaIni, posInicX, posInicY, linhas, colunas, leitura, dificult) { 
...
Aranha.prototype = { 
   ...
   retangulosColisao: function() {
      var rets = [
         {
           x: this.x+10, y: this.y+10, largura: 70, altura:  70
         }
      ];
